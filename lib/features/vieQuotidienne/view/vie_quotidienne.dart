...
class VieQuotidienneScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return   Scaffold(backgroundColor: AppColors.greenPrimary,
      body: SafeArea(
        bottom: false,
        child: SafeArea(
          bottom:false,
          child: Stack(
            children: [
              ...
              Positioned(
          bottom: -70, 
          child: SvgPicture.asset(SvgAssets.bottom_backgroundvq, 
        ...
        SizedBox(
          ...
          children: [
           Container(
             ...
             child: Column(spacing: 10, mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
               children: [
             TopNavigation(text: 'Vie quotidienne', buttonColor: AppColors.secondary),
             Padding(
             ...
             Padding(
               padding: const EdgeInsets.symmetric(horizontal: 10.0),
               child: 
             Text('Glisser les bons objets dans un sac.',
               style: TextStyle(
                 fontSize: 12,
