...
class _FrenchMagicDictationState extends State<FrenchMagicDictation> {
  ...
  final List<DictationWord> _words = [
    ...
    DictationWord(word: "merci", hint: "Ce qu'on dit quand on reçoit quelque chose"),
  ...
  Widget build(BuildContext context) {
    ...
    final currentWord = _currentWordIndex < _words.length 
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            Text('Dictée magique', style: TextStyle(
              color: AppColors.textPrimary,
              fontSize: 24,
              fontWeight: FontWeight.bold,
            )),
            
            Text("Travailler l'écoute et l'orthographe de mots simples.", 
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('$_correctAnswers mots réussis sur ${_words.length}', 
                            style: TextStyle(
                          ...
                          Text('Mot ${_currentWordIndex + 1}/${_words.length}', 
                            style: TextStyle(
                              color: AppColors.white,
                              fontSize: 16,
                            ),
                          ...
                          if (_showValidation) ...[
                            Text(
                              ...
                              style: TextStyle(
                                color: _isCorrect ? AppColors.accent : AppColors.orange,
                                fontWeight: FontWeight.bold,
                                fontSize: 18,
                              ),
                            ),
                          ...
                          CustomButtonNew(
                            buttonColor: _showValidation
                              ? (_isCorrect ? AppColors.accent : AppColors.orange)
                              : AppColors.secondary,
                            shadowColor: _showValidation
                              ? (_isCorrect 
                                  ? AppColors.accent2 
                            ...
                            onPressed: _showValidation ? _nextWord : _checkAnswer,
                            icon: _showValidation
