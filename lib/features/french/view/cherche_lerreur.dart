  ...
  void nextQuestion() {
    setState(() {
      if (currentQuestionIndex < questions.length - 1) {
        ...
        // Exercise completed
        Get.to(() => const FinishChercheLerreur(),
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            Text("Cherche l'erreur", style: TextStyle(
              color: AppColors.textPrimary,
              fontSize: 24,
              fontWeight: FontWeight.bold,
            )),
            
            Text("Travailler la correction grammaticale et l'attention aux détails.",
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('$correctAnswers mots réussis sur ${questions.length}', 
                            style: TextStyle(
                          ...
                          if (!answerChecked)
                            ...
                            CustomButtonNew(
                              buttonColor: isCorrect ? AppColors.accent : AppColors.orange, 
                              shadowColor: isCorrect ? AppColors.accent2 : AppColors.pinkMedium, 
