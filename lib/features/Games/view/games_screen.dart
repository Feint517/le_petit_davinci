          ...
          children: [
            ...
            Column(
              children: [
                ...
                Gap(10),
                SubHeader(
                  paragraph: "C'est l'heure de s'amuser !\n Choisis ton jeu préféré !", 
...
class GamesCards extends StatelessWidget {
  ...
  const GamesCards({
    super.key, required this.cardColor, required this.label, required this.title, required this.shadowColor, this.onTap, required this.assetPath,
  });
      ...
      children: [
        Container(
          ...
          child: Padding(
            ...
            child: Text(label, style: TextStyle(color: AppColors.white, fontSize: 12, fontWeight: FontWeight.w500)),
          ), 
        ...
        ,Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,spacing: 10,
            children: [
              ...
              CustomButtonNew(buttonColor: AppColors.secondary, shadowColor: AppColors.orangeAccentDark, label: 'Jouer', labelColor: AppColors.background,  )
            ],
          ),
        )
      ],
